...
<ResultsTable
  ...
  rows={[
    { label: "AutoEval &middot; Scoring accuracy", cells: [{ value: "72" }, { value: "64" }, { value: "80" }, { value: "88" }, { value: "76.0 ± 4.3" }] },
    { label: "AutoEval &middot; Verification accuracy", cells: [{ value: "76" }, { value: "80" }, { value: "80" }, { value: "76" }, { value: "78.0 ± 4.1" }] },
    { label: "AutoEval &middot; Reset SR", cells: [{ value: "52" }, { value: "64" }, { value: "16" }, { value: "76" }, { value: "52.0 ± 5.0" }] },
    { label: "MP skills &middot; Reset SR", cells: [{ value: "68" }, { value: "76" }, { value: "72" }, { value: "44" }, { value: "65.0 ± 4.8" }] },
    { label: "HALTER &middot; Scoring accuracy", highlight: true, cells: [{ value: "100" }, { value: "96" }, { value: "80" }, { value: "84" }, { value: "90.0 ± 3.0", strong: true, tone: "positive" }] },
    { label: "HALTER &middot; Plan validity", highlight: true, cells: [{ value: "92" }, { value: "84" }, { value: "72" }, { value: "88" }, { value: "84.0 ± 3.7", strong: true }] },
    { label: "HALTER &middot; Verification accuracy", highlight: true, cells: [{ value: "96" }, { value: "84" }, { value: "88" }, { value: "96" }, { value: "91.0 ± 2.9", strong: true, tone: "positive" }] },
    { label: "HALTER &middot; Reset SR", highlight: true, cells: [{ value: "88" }, { value: "84" }, { value: "48" }, { value: "84" }, { value: "76.0 ± 4.3", strong: true, tone: "positive" }] },
  ]}
...
<ResultsTable
  ...
  rowHeader="Method · Metric"
  rows={[
    { label: "AutoEval &middot; Scoring accuracy", cells: [{ value: "72" }, { value: "72" }, { value: "80" }, { value: "74.7 ± 5.0" }] },
    { label: "AutoEval &middot; Verification accuracy", cells: [{ value: "84" }, { value: "80" }, { value: "84" }, { value: "82.7 ± 4.4" }] },
    { label: "AutoEval &middot; Reset SR", cells: [{ value: "0" }, { value: "4" }, { value: "0" }, { value: "1.3 ± 1.3" }] },
    { label: "HALTER &middot; Scoring accuracy", highlight: true, cells: [{ value: "100" }, { value: "100" }, { value: "84" }, { value: "94.7 ± 2.6", strong: true, tone: "positive" }] },
    { label: "HALTER &middot; Plan validity", highlight: true, cells: [{ value: "92" }, { value: "96" }, { value: "80" }, { value: "89.3 ± 3.6", strong: true, tone: "positive" }] },
    { label: "HALTER &middot; Verification accuracy", highlight: true, cells: [{ value: "96" }, { value: "92" }, { value: "88" }, { value: "92.0 ± 3.1", strong: true, tone: "positive" }] },
    { label: "HALTER &middot; Reset SR", highlight: true, cells: [{ value: "84" }, { value: "84" }, { value: "56" }, { value: "74.7 ± 5.0", strong: true, tone: "positive" }] },
  ]}
